...
set psu_pll_init_data {
    ...
    mask_write 0XFD1A0020 0x00717F00 0x00013F00
		# : BY PASS PLL
		# Register : APLL_CTRL @ 0XFD1A0020</p>
...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E0084 0x013F3F07 0x01010F00
    ...
    mask_write 0XFF5E00C4 0x013F3F07 0x01013C00
		# Register : AMS_REF_CTRL @ 0XFF5E0108</p>
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD070060 0x00000073 0x00000021
    ...
    mask_write 0XFD070064 0x0FFF83FF 0x00248042
    ...
    mask_write 0XFD0700E0 0xFFFFFFFF 0x00180280
    ...
    mask_write 0XFD070120 0x7F7F7F7F 0x04040D04
    ...
    mask_write 0XFD080018 0xFFFFFFFF 0x00F04530
    ...
    mask_write 0XFD080120 0xFFFFFFFF 0x00842B08
    ...
    mask_write 0XFD08018C 0xFFFFFFFF 0x00000280
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180068 0x000000FE 0x00000060
    ...
    mask_write 0XFF18006C 0x000000FE 0x00000060
    ...
    mask_write 0XFF180070 0x000000FE 0x00000060
    ...
    mask_write 0XFF180074 0x000000FE 0x00000060
    ...
    mask_write 0XFF180204 0xFFFFFFFF 0x2C000000
    ...
    mask_write 0XFF180208 0xFFFFFCC0 0x00B03400
    ...
    mask_write 0XFF18015C 0x03FFFFFF 0x01FC0000
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFD1A0100 0x000F8046 0x00000000
		# : RESET BLOCKS
		# : TIMESTAMP
    ...
    mask_write 0XFF0A0244 0x03FFFFFF 0x00000030
		# : DIR MODE BANK 2
    ...
    mask_write 0XFF0A0248 0x03FFFFFF 0x00000030
    ...
    mask_write 0XFF0A0008 0xFFFFFFFF 0xFFEF0010
    ...
    mask_write 0XFF0A0008 0xFFFFFFFF 0xFFEF0000
		# : MASK_DATA_1_MSW HIGH BANK [51:42]
		# : MASK_DATA_1_LSW HIGH BANK [67:52]
		# : MASK_DATA_1_LSW HIGH BANK [77:68]
		# : ADD 5 MS DELAY
...
set psu_serdes_init_data {
    ...
    mask_write 0XFD410008 0x0000001F 0x00000011
    ...
    mask_write 0XFD40A368 0x000000FF 0x00000018
    ...
    mask_write 0XFD406368 0x000000FF 0x00000022
    ...
    mask_write 0XFD406370 0x000000FF 0x000000ED
    ...
    mask_write 0XFD406374 0x000000FF 0x00000055
    ...
    mask_write 0XFD40A370 0x000000FF 0x000000D3
    ...
    mask_write 0XFD40A374 0x000000FF 0x000000DA
    ...
    mask_write 0XFD4098F8 0x000000FF 0x00000096
    ...
    mask_write 0XFD4098FC 0x000000FF 0x00000096
    ...
    mask_write 0XFD409900 0x000000FF 0x00000096
    ...
    mask_write 0XFD410014 0x00000077 0x00000042
		# : CHECKING PLL LOCK
...
mwr -force  0xFD070060 0x00000020
