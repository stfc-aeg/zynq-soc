...
==============================
1.1 Note: "Module selection guide" modifies design_basic_settings file (Step 2.1) automatically on project creation
==============================
  ...
  Edit "design_basic_settings.cmd" with text editor:
    Set your vivado installation path for edit: 
      ...
      In this example the it search in 
        C:\Xilinx\Vivado\2018.3 for VIVADO
        C:\Xilinx\SDK\2018.3 for SDK (optional for some functionality, HSI/SDK)
        C:\Xilinx\Vivado_Lab\2018.3 for VIVADO Labtools (optional for programming only)
        C:\Xilinx\SDx\2018.3 for VIVADO SDSoC (optional SDSoC only)
...
2. Create Vivado Project on Linux use instructions from option 1 of:
  ...
  Edit "design_basic_settings.sh" with text editor:
    Set your vivado installation path for edit: 
      ...
      @set VIVADO_VERSION=2018.3
      In this example the it search in 
        /opt/Vivado/2018.3 for VIVADO
        /opt/SDK/2018.3 for SDK (optional for some functionality, HSI/SDK)
        /opt/Vivado_Lab/2018.3 for VIVADO Labtools (optional for programming only)
        /opt/SDx/2018.3 for VIVADO SDSoC (optional SDSoC only)
