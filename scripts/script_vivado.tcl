  ...
  namespace eval VLAB {
   # -----------------------------------------------------------------------------------------------------------------------------------------
    ...
    proc hw_create_flash_device {{fname ""}} {
      ...
      set_property PROGRAM.BLANK_CHECK  0 [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices $hw_fpga_name] 0]]
      set_property PROGRAM.ERASE  1 [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices $hw_fpga_name] 0]]
      set_property PROGRAM.CFG_PROGRAM  1 [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices $hw_fpga_name] 0]]
      set_property PROGRAM.VERIFY  0 [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices $hw_fpga_name] 0]]
      set_property PROGRAM.CHECKSUM  0 [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices $hw_fpga_name] 0]]
      ...
      if {$hw_fpga_name ne "NA"} {
        if {$use_basefolder} {
          ...
          if { ![catch {set bitfilename [glob -join -dir ${TE::BASEFOLDER}/ *.bit]}] } {
            ...
            set_property PROGRAM.FILE ${bitfilename} [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices $hw_fpga_name] 0]]
          } else {
          ...
          if {$app_name eq "" || $app_name eq "NA"} {
            if {[file exists ${TE::PREBUILT_HW_PATH}/${shortdir_int}/${TE::VPROJ_NAME}.bit]} {
              ...
              set_property PROGRAM.FILE ${TE::PREBUILT_HW_PATH}/${shortdir_int}/${TE::VPROJ_NAME}.bit [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices $hw_fpga_name] 0]]
              if {[file exists ${TE::PREBUILT_HW_PATH}/${shortdir_int}/${TE::VPROJ_NAME}.ltx]} {
                set_property PROBES.FILE ${TE::PREBUILT_HW_PATH}/${shortdir_int}/${TE::VPROJ_NAME}.ltx [get_hw_devices $hw_fpga_name]
              } else {
                TE::UTILS::te_msg TE_PR-6 INFO "Probes file (${TE::PREBUILT_HW_PATH}/${shortdir_int}/${TE::VPROJ_NAME}.ltx)doesn't exist."
                set_property PROBES.FILE "" [get_hw_devices $hw_fpga_name]
              }
              ...
              if {[file exists ${TE::PREBUILT_HW_PATH}/default/${TE::VPROJ_NAME}.bit]} {
                set_property PROGRAM.FILE ${TE::PREBUILT_HW_PATH}/default/${TE::VPROJ_NAME}.bit [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices $hw_fpga_name] 0]]
                if {[file exists ${TE::PREBUILT_HW_PATH}/default/${TE::VPROJ_NAME}/${TE::VPROJ_NAME}.ltx]} {
                  set_property PROBES.FILE ${TE::PREBUILT_HW_PATH}/default/${TE::VPROJ_NAME}.ltx [get_hw_devices $hw_fpga_name]
                } else {
                  TE::UTILS::te_msg TE_PR-8 INFO "Probes file (${TE::PREBUILT_HW_PATH}/default/${TE::VPROJ_NAME}.ltx) doesn't exist."
                  set_property PROBES.FILE "" [get_hw_devices $hw_fpga_name]
                }
                ...
                TE::UTILS::te_msg TE_PR-10 ERROR "${TE::PREBUILT_HW_PATH}/${shortdir_int}/${TE::VPROJ_NAME}.bit doesn't exist. Nothing is done."
                return -code error
              }
            }
          } else {
            ...
            if { ![catch {set bitfilename [glob -join -dir ${TE::PREBUILT_BI_PATH}/${shortdir_int}/${app_name}/ *.bit]}] } {
              ...
              if {[file exists ${TE::PREBUILT_HW_PATH}/${shortdir_int}/${TE::VPROJ_NAME}.ltx]} {
                ...
                TE::UTILS::te_msg TE_PR-11 INFO "Probes file (${TE::PREBUILT_HW_PATH}/${shortdir_int}/${TE::VPROJ_NAME}.ltx)  doesn't exist."
                set_property PROBES.FILE "" [get_hw_devices $hw_fpga_name]
              }
      ...
      if {$hw_fpga_name ne "NA"} {
        if {$use_basefolder} {
          ...
          if { ![catch {set binfilename [glob -join -dir ${TE::BASEFOLDER}/ *.bin]}] } {
            ...
            if {[file exists ${TE::BASEFOLDER}/zynqmp_fsbl_flash.elf]} {
              set_property PROGRAM.ZYNQ_FSBL ${TE::BASEFOLDER}/zynqmp_fsbl_flash.elf [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices $hw_fpga_name] 0]]      
              
            } elseif {[file exists ${TE::BASEFOLDER}/zynq_fsbl_flash.elf]} {
              set_property PROGRAM.ZYNQ_FSBL ${TE::BASEFOLDER}/zynq_fsbl_flash.elf [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices $hw_fpga_name] 0]]              
            } else {
              TE::UTILS::te_msg TE_PR-85 {CRITICAL WARNING} "Zynq FSBL file (${TE::BASEFOLDER}/zynq_fsbl_flash.elf or zynqmp_fsbl_flash.elf) doesn't exist." 
            }           
          ...
          if { ![catch {set binfilename [glob -join -dir ${TE::PREBUILT_BI_PATH}/${shortdir_int}/${app_name}/ *.bin]}] } {
            ...
            if {[file exists ${TE::PREBUILT_HW_PATH}/${shortdir_int}/${TE::VPROJ_NAME}.ltx]} {
              ...
              TE::UTILS::te_msg TE_PR-17 INFO "Probes file (${TE::PREBUILT_HW_PATH}/${shortdir_int}/${TE::VPROJ_NAME}.ltx) doesn't exist."
              set_property PROBES.FILE "" [get_hw_devices $hw_fpga_name]
            }
        ...
        if {$use_basefolder} {
          ...
          if {$app_name eq "" || $app_name eq "NA"} {
            ...
            if {[file exists ${TE::PREBUILT_HW_PATH}/${shortdir_int}/${TE::VPROJ_NAME}.mcs]} {
              set_property PROGRAM.ADDRESS_RANGE  {use_file} [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices $hw_fpga_name] 0]]
              set_property PROGRAM.FILES [list "${TE::PREBUILT_HW_PATH}/${shortdir_int}/${TE::VPROJ_NAME}.mcs" ] [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices $hw_fpga_name] 0]]  
              if {[file exists ${TE::PREBUILT_HW_PATH}/${shortdir_int}/${TE::VPROJ_NAME}.prm]} {
                set_property PROGRAM.PRM_FILE "${TE::PREBUILT_HW_PATH}/${shortdir_int}/${TE::VPROJ_NAME}.prm" [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices $hw_fpga_name] 0]]  
              } else {
                set_property PROGRAM.PRM_FILE "" [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices $hw_fpga_name] 0]]  
                TE::UTILS::te_msg TE_PR-87 INFO "PRM file (${TE::PREBUILT_HW_PATH}/${shortdir_int}/${TE::VPROJ_NAME}.prm) doesn't exist."
              }
              set_property PROGRAM.UNUSED_PIN_TERMINATION ${term} [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices $hw_fpga_name] 0]]       
              if {[file exists ${TE::PREBUILT_HW_PATH}/${shortdir_int}/${TE::VPROJ_NAME}.ltx]} {
                set_property PROBES.FILE ${TE::PREBUILT_HW_PATH}/${shortdir_int}/${TE::VPROJ_NAME}.ltx [get_hw_devices $hw_fpga_name]
              } else {
                TE::UTILS::te_msg TE_PR-23 INFO "Probes file (${TE::PREBUILT_HW_PATH}/${shortdir_int}/${TE::VPROJ_NAME}.ltx) doesn't exist."
                set_property PROBES.FILE "" [get_hw_devices $hw_fpga_name]
              }
              ...
              TE::UTILS::te_msg TE_PR-25 ERROR "${TE::PREBUILT_HW_PATH}/${shortdir_int}/${TE::VPROJ_NAME}.mcs doesn't exist. Nothing is done"
              return -code error
            }
          } else {
            ...
            if { ![catch {set mcsfilename [glob -join -dir ${TE::PREBUILT_BI_PATH}/${shortdir_int}/${app_name}/ *.mcs]}] } {
              ...
              if {[file exists ${TE::PREBUILT_HW_PATH}/${shortdir_int}/${TE::VPROJ_NAME}.ltx]} {
                ...
                TE::UTILS::te_msg TE_PR-26 INFO "Probes file (${TE::PREBUILT_HW_PATH}/${shortdir_int}/${TE::VPROJ_NAME}.ltx) doesn't exist."
                set_property PROBES.FILE "" [get_hw_devices $hw_fpga_name]
              }
    ...
    proc hw_reload_prope_file_device {{fname ""}} {
      ...
      if {[file exists ${TE::PREBUILT_HW_PATH}/${shortdir_int}/${TE::VPROJ_NAME}.ltx]} {
        ...
        TE::UTILS::te_msg TE_PR-31 INFO "Probes file (${TE::PREBUILT_HW_PATH}/${shortdir_int}/${TE::VPROJ_NAME}.ltx)  doesn't exist."
        set_property PROBES.FILE "" [get_hw_devices $hw_fpga_name]
      }
    }  
    # -----------------------------------------------------------------------------------------------------------------------------------------
