  ...
  proc help {{args ""}} {
    ...
    if {$run_help} {
      ...
      if {![catch {set projectname [get_projects]} result]} {
        ...
        \  ----------\n\
        \  Software Design:\n\
        \    TE::sw_run_hsi \[-run_only\] \[-prebuilt_hdf_only\] \[-prebuilt_hdf <arg>\] \[-no_hsi\] \[-no_bif\] \[-no_bin\] \[-no_bitmcs\] \[-force_bin\]  \[-clear\] \[-help\]\n\
  ...
  proc pr_putty {{args ""}} {
    ...
    if {$run_help} {
      ...
      TE::UTILS::te_msg TE_PR-91 STATUS $te_txt
        ...
        if {${display_com}} {
          set printout [TE::EXT::run_putty true]
          ...
          if {[catch {   
            ...
            set printout [TE::EXT::run_putty false]
